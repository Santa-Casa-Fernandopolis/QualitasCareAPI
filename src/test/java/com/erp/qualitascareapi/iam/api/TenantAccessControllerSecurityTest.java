...
@ActiveProfiles("test")
class TenantAccessControllerSecurityTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    @DisplayName("should allow fetching tenants without authentication")
    void shouldExposeTenantLookupWithoutAuthentication() throws Exception {
